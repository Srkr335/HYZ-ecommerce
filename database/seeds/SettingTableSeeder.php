...
class SettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data=array(
            ...
            'photo'=>"image.jpg",
            'logo'=>'logo.jpg',
            'address'=>"HYZ VENTURES INTL PRIVATE LIMITED  company in Kerala,Technopark Trivandrum, Padmanabham Building, Technopark Campus, Thiruvananthapuram, Kerala 695581",
            'email'=>"hyzventures@gmail.com",
            'phone'=>"+060 (200) 801-582",
        );
